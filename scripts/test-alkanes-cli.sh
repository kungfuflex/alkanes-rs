./target/release/alkanes-cli --wallet-file ~/.alkanes/wallet.json -p regtest bitcoind generatetoaddress 401 p2tr:0
sleep 10
...
./target/release/alkanes-cli -p regtest alkanes getbytecode "4:$((0x1f00))"
