...
fn network_to_params(network: bitcoin::Network) -> NetworkParams {
    match network {
        bitcoin::Network::Bitcoin => NetworkParams::from_network_str("mainnet").unwrap(),
        bitcoin::Network::Testnet => NetworkParams::from_network_str("testnet").unwrap(),
        bitcoin::Network::Signet => NetworkParams::from_network_str("signet").unwrap(),
        bitcoin::Network::Regtest => NetworkParams::regtest(),
        _ => NetworkParams::from_network_str("mainnet").unwrap(),
    }
}
