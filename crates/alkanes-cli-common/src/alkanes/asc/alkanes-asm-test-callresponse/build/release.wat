(module
 ...
 (data $11.1 (i32.const 1608) "\0f\00\00\00\08\00\00\00\01")
 (data $12 (i32.const 1628) "\1c")
 (data $12.1 (i32.const 1640) "\11\00\00\00\08\00\00\00\02")
 (data $13 (i32.const 1660) "\1c")
 (data $13.1 (i32.const 1672) "\12\00\00\00\08\00\00\00\03")
 (data $14 (i32.const 1692) "\1c")
 (data $14.1 (i32.const 1704) "\15\00\00\00\08\00\00\00\04")
 (data $15 (i32.const 1728) "\16\00\00\00 \00\00\00 \00\00\00 ")
 (data $15.1 (i32.const 1764) " \00\00\00\02A")
 (data $15.2 (i32.const 1780) "\02A\00\00 \00\00\00\02A\00\00\00\00\00\00\02\t")
 (data $15.3 (i32.const 1808) "B\00\00\00A")
 (table $0 5 5 funcref)
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$259
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$259
   end
   local.get $0
   i32.load offset=8
   local.tee $2
       ...
       block $invalid
        block $~lib/array/Array<u8>
         block $~lib/array/Array<i32>
          block $../alkanes-asm-common/assembly/utils/box/Box
             ...
             block $~lib/string/String
              block $~lib/arraybuffer/ArrayBuffer
               block $~lib/object/Object
                ...
                i32.sub
                i32.load
                br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner5 $../alkanes-asm-common/assembly/alkanes/types/ExtendedCallResponse $folding-inner5 $folding-inner1 $folding-inner1 $~lib/as-bignum/assembly/integer/u128/u128 $folding-inner2 $folding-inner5 $folding-inner1 $folding-inner2 $../alkanes-asm-common/assembly/utils/box/Box $folding-inner2 $folding-inner3 $~lib/array/Array<i32> $folding-inner3 $folding-inner3 $~lib/array/Array<u8> $folding-inner5 $folding-inner3 $invalid
               end
               return
              end
              return
 ...
 (func $../alkanes-asm-common/assembly/utils/box/Box.from (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $../alkanes-asm-common/assembly/parcel/AlkaneTransferParcel#serialize~anonymous|0 (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  block $folding-inner0
   ...
   i32.store
   local.get $2
   call $../alkanes-asm-common/assembly/utils/box/Box.from
   local.set $0
   global.get $~lib/memory/__stack_pointer
   i32.const 8
   i32.add
 ...
 (func $~lib/array/Array<../alkanes-asm-common/assembly/utils/box/Box>#reduce<i32> (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $../alkanes-asm-common/assembly/utils/box/Box.concat (param $0 i32) (result i32)
  ...
  i32.const 1648
  i32.const 0
  call $~lib/array/Array<../alkanes-asm-common/assembly/utils/box/Box>#reduce<i32>
  call $~lib/arraybuffer/ArrayBuffer#constructor
  local.tee $1
  i32.store offset=8
  global.get $~lib/memory/__stack_pointer
 ...
 (func $~lib/array/Array<../alkanes-asm-common/assembly/parcel/AlkaneTransfer>#get:length (param $0 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  block $folding-inner0
   ...
   if
    ...
    if
     ...
     local.get $0
     i32.store
     block $__inlined_func$~lib/rt/itcms/__renew$255
      i32.const 1073741820
      local.get $4
      i32.const 1
      i32.shl
      ...
      if
       ...
       local.get $4
       local.set $3
       br $__inlined_func$~lib/rt/itcms/__renew$255
      end
      local.get $5
      local.get $7
      i32.load offset=12
 ...
 (func $../alkanes-asm-common/assembly/parcel/AlkaneTransferParcel#serialize (param $0 i32) (result i32)
  ...
  block $folding-inner0
   ...
   i32.store offset=12
   local.get $0
   call $~lib/array/Array<../alkanes-asm-common/assembly/parcel/AlkaneTransfer>#get:length
   i64.extend_i32_s
   local.tee $1
   local.get $1
   i64.const 63
