(module
 ...
 (func $../alkanes-asm-common/assembly/parcel/AlkaneTransferParcel#set:transfers (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
 )
 (func $../alkanes-asm-common/assembly/alkanes/types/ExtendedCallResponse#constructor (result i32)
  ...
  local.tee $0
  i32.const 0
  call $../alkanes-asm-common/assembly/parcel/AlkaneTransferParcel#set:transfers
  local.get $0
  i32.const 0
  call $~lib/rt/common/OBJECT#set:gcInfo
  local.get $0
 ...
 (func $../alkanes-asm-common/assembly/alkanes/types/ExtendedCallResponse#setData (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $~lib/rt/common/OBJECT#set:gcInfo2
 )
 ...
 (func $../alkanes-asm-common/assembly/u128/u128#set:hi (param $0 i32)
  local.get $0
  i64.const 0
  i64.store offset=8
 )
 (func $../alkanes-asm-common/assembly/u128/storeU128 (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i64.load
  i64.store
 ...
 (func $../alkanes-asm-common/assembly/alkanes/types/ExtendedCallResponse#finalize (param $0 i32) (result i32)
  ...
  local.get $9
  local.get $1
  call $../alkanes-asm-common/assembly/u128/storeU128
  i32.const 16
  local.set $1
  loop $for-loop|0
   local.get $2
 ...
 (func $assembly/index/__execute (result i32)
  ...
  if
   ...
   local.get $1
   local.get $0
   call $../alkanes-asm-common/assembly/alkanes/types/ExtendedCallResponse#setData
   local.get $1
