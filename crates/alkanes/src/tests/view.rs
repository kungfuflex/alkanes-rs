...
mod tests {
    ...
    fn test_get_statics_caching() -> Result<()> {
        ...
        let (name1, symbol1) = get_statics::<crate::tests::test_runtime::TestRuntime>(&test_id);
        ...
        let (name2, symbol2) = get_statics::<crate::tests::test_runtime::TestRuntime>(&test_id);
        ...
        let (different_name, different_symbol) = get_statics::<crate::tests::test_runtime::TestRuntime>(&different_id);
        ...
        let (name3, symbol3) = get_statics::<crate::tests::test_runtime::TestRuntime>(&test_id);
