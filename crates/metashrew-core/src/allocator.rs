...
static ACTUAL_LRU_CACHE_MEMORY_LIMIT: crate::lazy_cell::LazyLock<usize> =
    crate::lazy_cell::LazyLock::new(|| detect_available_memory());
...
static PREALLOCATED_CACHE_MEMORY: crate::lazy_cell::LazyLock<Vec<u8>> = crate::lazy_cell::LazyLock::new(|| {
...
static PREALLOCATED_ALLOCATOR: crate::lazy_cell::LazyLock<PreallocatedBumpAllocator> =
    crate::lazy_cell::LazyLock::new(|| PreallocatedBumpAllocator::new());
