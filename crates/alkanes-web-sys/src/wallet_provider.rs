...
//!         Ok(provider)
//!     } else {
//!         Err(AlkanesError::Wallet("No wallets detected".to_string()))
//!     }
//! }
//! ```
...
use alkanes_cli_common::{*, alkanes::{AlkanesInspectConfig, AlkanesInspectResult, AlkaneBalance}, provider::{AllBalances, AssetBalance, EnrichedUtxo}};
...
impl AlkanesProvider for BrowserWalletProvider {
    ...
    async fn resume_execution(
        ...
        params: &alkanes_cli_common::alkanes::types::EnhancedExecuteParams,
