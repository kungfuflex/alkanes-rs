use crate::common::{self as alkane_helpers, assert_revert_context, get_last_outpoint_sheet, get_sheet_for_outpoint, clear};
...
fn setup_pre_upgrade() -> Result<()> {
    ...
    alkanes::WasmHost::default().index_block(&test_block, 880_000)?; // just to init the diesel
    Ok(())
}
